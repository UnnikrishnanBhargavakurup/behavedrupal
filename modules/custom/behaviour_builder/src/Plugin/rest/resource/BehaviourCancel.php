 ...
 * @RestResource(
 *   id = "behaviour_cancel",
 *   label = @Translation("Behaviour builder cancel account "),
 *   uri_paths = {
 *     "canonical" = "/behave/cancel",
 *     "https://www.drupal.org/link-relations/create" = "/behave/cancel"
 *   },
 *   serialization_class = "Drupal\behaviour_builder\normalizer\JsonDenormalizer",
 * )
 */
class BehaviourCancel extends ResourceBase {
